  ...
  useEffect(() => {
    async function fetchAll() {
      ...
      try {
        ...
        const nextUserType = profileRes.data.userType ?? "";
        setUserType(nextUserType);

        if (nextUserType === "student" && String(mentorUserId) !== String(currentUserId)) {
        ...
        <div>
          <div style={profileHeaderStyle}>
            ...
            {userType === "student" && !isOwnProfile ? (
              <button onClick={handleBookmark} disabled={bookmarkLoading} style={bookmarkButtonStyle(bookmarked, bookmarkLoading)}>
...
function bookmarkButtonStyle(bookmarked, loading) {
  return {
    padding: "8px 16px",
